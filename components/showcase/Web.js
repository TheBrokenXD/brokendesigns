        ...
        <>
            <div className="row gap-2 mt-2">
                <div className="col-4-xl col-6-lg col-12-xs">
                    <a href="https://broken-lazy-docs.vercel.app/" target="_blank" rel="noreferrer"><img src="web/lazyy.png" alt="cover-1" className="thumb-cover br-base" /></a>
                ...
                <div className="col-4-xl col-6-lg col-12-xs">
                    <a href="https://client-starpanel.vercel.app/" target="_blank" rel="noreferrer"><img src="web/starpanel.png" alt="cover-1" className="thumb-cover br-base" /></a>
                ...
                <div className="col-4-xl col-6-lg col-12-xs">
                    <a href="http://allensmarketingbots.tech/" target="_blank" rel="noreferrer"><img src="web/allen.png" alt="cover-1" className="thumb-cover br-base" /></a>
