        ...
        <>
            <div className="row gap-2 mt-2">
                <div className="col-4-xl col-6-lg col-12-xs">
                    <Link href="/works/reel2021"><img src="index-thumbnail/reel.png" alt="cover" className="thumb-cover br-base" /></Link>
                ...
                <div className="col-4-xl col-6-lg col-12-xs">
                    <Link href="/works/promo3d"><img src="index-thumbnail/3d-promo.png" alt="cover" className="thumb-cover br-base" /></Link>
                ...
                <div className="col-4-xl col-6-lg col-12-xs">
                    <Link href="/works/dcoderz"><img src="index-thumbnail/dcoderz.png" alt="cover" className="thumb-cover br-base" /></Link>
                ...
                <div className="col-4-xl col-6-lg col-12-xs">
                    <Link href="/works/notifications"><img src="index-thumbnail/noti.png" alt="cover" className="thumb-cover br-base" /></Link>
                ...
                <div className="col-4-xl col-6-lg col-12-xs">
                    <Link href="/works/valentine"><img src="index-thumbnail/valentine.png" alt="cover" className="thumb-cover br-base" /></Link>
                ...
                <div className="col-4-xl col-6-lg col-12-xs">
                    <Link href="/works/soon"><img src="index-thumbnail/soon.png" alt="cover" className="thumb-cover br-base" /></Link>
                ...
                <div className="col-4-xl col-6-lg col-12-xs">
                    <Link href="/works/fabiconv2"><img src="index-thumbnail/fabicon-v2.png" alt="cover" className="thumb-cover br-base" /></Link>
                ...
                <div className="col-4-xl col-6-lg col-12-xs">
                    <Link href="/works/fabiconv1"><img src="index-thumbnail/fabicon-v1.png" alt="cover" className="thumb-cover br-base" /></Link>
                ...
                <div className="col-4-xl col-6-lg col-12-xs">
                    <Link href="/works/vincenzo"><img src="index-thumbnail/vincenzo.png" alt="cover" className="thumb-cover br-base" /></Link>
                ...
                <div className="col-4-xl col-6-lg col-12-xs">
                    <Link href="/works/jayanth"><img src="index-thumbnail/jayanth.png" alt="cover" className="thumb-cover br-base" /></Link>
