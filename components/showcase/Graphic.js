        ...
        <>
            <div className="row gap-2 mt-2">
                <div className="col-4-xl col-6-lg col-12-xs">
                    ...
                    <p className="custom-text font-lg fw-md pt-1"><Link href="/work/broken"><span className="pointer custom-misc-hover">Broken - Brand</span></Link></p>
                ...
                <div className="col-4-xl col-6-lg col-12-xs">
                    ...
                    <p className="custom-text font-lg fw-md pt-1"><Link href="/work/noah"><span className="pointer custom-misc-hover">Noah - Identity</span></Link></p>
